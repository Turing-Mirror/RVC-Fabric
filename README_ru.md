...
- **Отказ от ответственности**: Пожалуйста, не используйте это программное обеспечение для подделки личности, мошенничества, домогательств или любых несанкционированных незаконных целей. Перед использованием голоса других людей для обучения или преобразования необходимо получить явное разрешение от первоначального правообладателя. Все юридические последствия, возникающие в результате незаконного использования, несет пользователь.
