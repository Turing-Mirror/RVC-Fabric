...
_FALLBACK_ZH: dict[str, str] = {
    ...
    CKPT_MKDIR_FAILED: "建不了输出目录：{error}",
    ...
    CKPT_BAD_REQUEST: "读不了请求文件：{error}",
    CKPT_STARTING: "开始…",
    CKPT_UNKNOWN_ACTION: "未知操作：{action}",
    STS_NO_REQUEST: "缺请求文件参数",
    STS_BAD_REQUEST: "请求文件读不了：{error}",
    ...
    TRAIN_BAD_REQUEST: "读不了请求文件：{error}",
