...
- [Ultimate Vocal Remover](https://github.com/Anjok07/ultimatevocalremovergui) (Modelos de separación de la serie UVR, ejecutados a través de PyMSS) · [FFmpeg](https://github.com/FFmpeg/FFmpeg) — Separación de voz y procesamiento de audio
