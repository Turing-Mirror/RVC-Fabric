...
#
# 与 Clownfish 2.05 对应的档位按反汇编结论（`docs/clownfish_dsp_逆向对比报告.md`）
# 精确复刻：
...
BUILTIN: List[Dict[str, Any]] = [
    ...
    },
    {
        "id": "robot",
        "name": "机器人",
        # Clownfish Robot 的正身：rate/25 长的整周期 sin 窗乘输入 = 25Hz 环形调制。
    ...
    },
    {
        "id": "alien",
        "name": "外星人",
        # Clownfish Alien：乒乓双缓冲分块倒放，约 200ms 一块。
    ...
    },
    {
        "id": "radio",
        "name": "老收音机",
        # Clownfish Old Radio：纯半波整流 max(0,x)，不附带任何 EQ。
    ...
    },
    {
        "id": "retro8bit",
        "name": "8-bit",
        # Clownfish Atari：音高在 +6/-3 半音间方波跳变，约每 70ms 翻一次。
    ...
    },
    {
        "id": "ghost",
        "name": "幽灵",
        # Clownfish 空间档 Ghost：反向读延迟线 ≈ 250ms 的持续反向回声。
        "desc": "刚说过的话倒着渗回来，阴湿",
    ...
    },
    {
        "id": "male_to_female",
        "name": "男声转女声",
        # Clownfish Female = +4 半音（原来是拍脑袋的 4.5）。
        "desc": "升 4 半音，共振峰跟着走",
    ...
    },
    {
        "id": "chorus_crowd",
        "name": "一群人",
        # Clownfish Clone：125ms 单抽头 slapback，0.5·in + 0.5·延迟，无反馈。
    ...
    },
    {
        "id": "cave",
        "name": "山洞",
        # Clownfish 空间档 Cave：62.5ms 回声，反馈 0.5。
    ...
    },
    {
        "id": "mutation",
        "name": "变异",
        # Clownfish Mutation（10）：音高三角扫 -4~+13，每块 0.1 半音。
    ...
    },
    {
        "id": "fast_mutation",
        "name": "快速变异",
        # Clownfish Fast Mutation（12）：同样的三角扫，每块 0.3 半音。
        "desc": "音高快速扫动，三秒一个来回",
    ...
    },
    {
        "id": "slow_mutation",
        "name": "缓慢变异",
        # Clownfish Slow Mutation（11）：每块只挪 0.01 半音，一分半钟才扫完一遍。
